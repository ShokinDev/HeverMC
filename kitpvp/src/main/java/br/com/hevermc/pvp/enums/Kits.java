...
public enum Kits {
	...
	CRITICAL("Critical", "Dê danos criticos em seu adversário.", Material.GLOWSTONE, Material.AIR, Groups.LEGEND),
	...
	SWITCHER("Switcher", "Troque de lugar com seus inimigos.", Material.SNOW_BALL, Material.SNOW_BALL, Groups.LEGEND),
	AJNIN("Ajnin", "Agache para trazer seus inimigos até você.", Material.NETHER_STAR, Material.AIR, Groups.CRYSTAL),
	...
	SPIDERMAN("SpiderMan", "Vire o spiderman.", Material.STRING, Material.STRING, Groups.LEGEND),
	DESHFIRE("Deshfire", "Incendeie todos abaixo de você.", Material.REDSTONE_BLOCK, Material.REDSTONE_BLOCK,Groups.CRYSTAL),
	MAGMA("Magma", "Incendeie seu inimigo.", Material.MAGMA_CREAM, Material.AIR, Groups.LEGEND),
	FIREMAN("Fireman", "Seja imune a fogo.", Material.LAVA_BUCKET, Material.AIR, Groups.LEGEND),
	C4("C4", "Entre para ALQaeda.", Material.SLIME_BALL, Material.SLIME_BALL, Groups.LEGEND),
	SUMO("Sumo", "Lance seus inimigos para o céu.", Material.APPLE, Material.APPLE, Groups.MEMBRO),
	HOTPOTATO("HotPotato", "Exploda seu inimigo com sua batata.", Material.BAKED_POTATO, Material.BAKED_POTATO, Groups.CRYSTAL),
