 ...
 * @see <a href=
 *      "https://www.spigotmc.org/wiki/bukkit-bungee-plugin-messaging-channel/">https://www.spigotmc.org/wiki/bukkit-bungee-plugin-messaging-channel/</a>
 */
public class BungeeChannelApi {
	 ...
	 * @see <a href=
	 *      "https://www.spigotmc.org/wiki/bukkit-bungee-plugin-messaging-channel/#forward">https://www.spigotmc.org/wiki/bukkit-bungee-plugin-messaging-channel/#forward</a>
	 */
	 ...
	 *
	 * @param serverName the server name of the server to get the player count of,
	 ...
	 *
	 * @param serverName the name of the server to get the list of connected
	 *                   players, or ALL for global online player list
	 ...
	 * @param serverName the name of server to connect to, as defined in BungeeCord
	 *                   config.yml.
	 */
	public void connect(Player player, String serverName) {
		try {
			...
			player.sendMessage("§b§lCONNECT §fNão foi possivel conectar a este servidor.");
		}
	}
	 ...
	 * @param server     name of server to connect to, as defined in BungeeCord
	 *                   config.yml.
	 * @throws IllegalArgumentException if there is no players online.
	 */
	...
	public void sendPluginMessage(Player player, String message, String channel) {
	 ...
	 * a player online.</b>
	 *
	 * @param server      the name of the server to send to, ALL to send to every
	 *                    server (except the one sending the plugin message), or
	 *                    ONLINE to send to every server that's online (except the
	 *                    one sending the plugin message).
	 *
	...
	private Player getFirstPlayer() {
		/**
		 * if Bukkit Version < 1.7.10 then Bukkit.getOnlinePlayers() will return a
		 * Player[] otherwise it'll return a Collection<? extends Player>.
		 */
